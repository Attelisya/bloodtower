        ...
        this.characters = {
            trouble_brewing: {
                good: [
                    ...
                    {id: 5, name: 'Эмпат', ability: 'Каждую ночь вы узнаете, сколько из ваших соседей злые.'},
                    {id: 6, name: 'Гадалка', ability: 'Каждую ночь вы выбираете двух игроков и узнаете, является ли хотя бы один из них Демоном.'},
                    ...
                    {id: 10, name: 'Городской дурачок', ability: 'Каждую ночь вы можете переместиться с позиции, где вы сидите, на другое место, изменяя порядок рассадки игроков.'},
                    {id: 11, name: 'Солдат', ability: 'Вы не можете умереть от атаки демона.'},
                    {id: 12, name: 'Мэр', ability: 'Если нет казни при равенстве голосов, вы решаете, кто будет казнен. Если вы умираете после 5 или более живых игроков, ваша команда проигрывает.'},
